...
public class GitWorktreeDetector {
  ...
  /// Resolves the git root for a path.
  /// Returns nil when the path is not inside a git work tree.
  public static func resolveGitRoot(for directoryPath: String) async -> String? {
    let process = Process()
