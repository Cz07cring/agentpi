...
public enum CLILoadingState: Equatable, Sendable {
  ...
  case repositoryValidationFailed(message: String)
  ...
  public var isLoading: Bool {
    switch self {
    case .idle, .repositoryValidationFailed:
      return false
    case .restoringRepositories, .restoringMonitoredSessions, .addingRepository, .detectingWorktrees, .scanningSessions, .refreshing:
      return true
    }
  }
  ...
  public var message: String {
    ...
    case .repositoryValidationFailed(let message): return message
